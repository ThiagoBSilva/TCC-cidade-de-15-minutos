...
class H3ClientService:
    ...
    def obter_hexagonos_h3_por_poligono(self, poligono: Polygon) -> list[str]:
        try:
            ...
            log.error(msg=f"Houve um erro ao obter os hexágonos H3 a partir do polígono. "
    ...
    def obter_poligono_hexagono_h3(self, hexagono_h3: str) -> Polygon:
        try:
            ...
            log.error(msg=f"Houve um erro ao obter o polígono do hexágono H3 {hexagono_h3}. "
                          f"{ExceptionUtil.montar_erro_exception_padrao(e)}")
            raise e