...
class IBGEClientService:
    ...
    def obter_shapefile_unidades_federativas(self) -> None:
        try:
            ...
            log.error(msg=f"Houve um erro ao buscar o shapefile das unidades federativas. {ExceptionUtil.montar_exception_padrao(e)}")
            raise e
    ...
    def obter_shapefile_municipios(self) -> None:
        try:
            ...
            log.error(msg=f"Houve um erro ao buscar o shapefile dos municípios. {ExceptionUtil.montar_exception_padrao(e)}")
            raise e
