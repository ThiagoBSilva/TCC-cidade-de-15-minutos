class CargaInicialQueriesConstantes:
    ...
    POPULAR_TABELAS_INICIAIS = '''
        ...
        ('amenity=internet_cafe', 'LAN house', 21),
        ('amenity=place_of_worship', 'Lugar de culto', 22),
        ('building=church', 'Igreja', 22),
        ...
        ('amenity=community_centre', 'Centro comunitário', 28),
        ('amenity=conference_centre', 'Centro de conferências', 28),
        ('amenity=events_venue', 'Local de eventos', 28),
        ('amenity=exhibition_centre', 'Centro de exposições', 28),
        ('amenity=music_venue', 'Local de música', 28),
        ('building=sports_centre', 'Centro esportivo', 29),
        ('leisure=sports_centre', 'Centro esportivo', 29),
        ('sport=multi', 'Esportes múltiplos', 29),
        ('amenity=social_centre', 'Centro social', 30),
        ('amenity=cinema', 'Cinema', 31),
        ('leasure=common', 'Espaço comum', 32),
        ('leisure=garden', 'Jardim', 33),
        ('leisure=nature_reserve', 'Reserva natural', 33),
        ('leisure=swimming_area', 'Área de natação', 34),
        ('leisure=swimming_pool', 'Piscina', 34),
        ('leisure=water_park', 'Parque aquático', 34),
        ('building=museum', 'Museu', 35),
        ('tourism=museum', 'Museu', 35),
