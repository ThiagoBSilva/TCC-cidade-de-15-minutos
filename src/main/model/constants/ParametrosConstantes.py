...
class ParametrosConstantes:
    ...
    BATCH_QTDE_REGISTROS_ETAPA_GERACAO_MALHA = 5
    BATCH_QTDE_PARTICOES_DASK_ETAPA_GERACAO_MALHA = 5
    ...
    BATCH_LIMPAR_CACHE = False

    # Parâmetros de configuração do OSMnx
    OSMXN_USAR_CACHE = True
    OSMNX_URL_NOMINATIM_LOCAL = "http://localhost:8080/"
    OSMNX_URL_OVERPASS_LOCAL = "http://localhost:80/api"