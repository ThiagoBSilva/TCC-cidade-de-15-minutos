...
class ParametrosConstantes:
    ...
    CAMINHO_LOG_CALCULO_INDICE_MUNICIPIO = DIRETORIO_LOGS + "/5_calculo_indice_municipio.log"
    CAMINHO_LOG_CALCULO_INDICE_UNIDADE_FEDERATIVA = DIRETORIO_LOGS + "/6_calculo_indice_unidade_federativa.log"
    ...
    BATCH_QTDE_REGISTROS_ETAPA_EXTRACAO_AMENIDADES = 20
    BATCH_QTDE_PARTICOES_DASK_ETAPA_EXTRACAO_AMENIDADES = 5

    BATCH_QTDE_REGISTROS_ETAPA_CALCULO_MATRIZ_TEMPO_VIAGEM = 10
    BATCH_QTDE_PARTICOES_DASK_ETAPA_CALCULO_MATRIZ_TEMPO_VIAGEM = 1

    BATCH_QTDE_REGISTROS_ETAPA_CALCULO_INDICE_MUNICIPIO = 100
    BATCH_QTDE_PARTICOES_DASK_ETAPA_CALCULO_INDICE_MUNICIPIO = 1
