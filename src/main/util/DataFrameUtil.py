...
class DataFrameUtil:
    ...
    def dict_para_dataframe(dict_dados: dict) -> DataFrame:
        try:
            ...
            log.error(msg=f"Houve um erro ao gerar o DataFrame a partir do dict. {ExceptionUtil.montar_exception_padrao(e)}")
            raise e
    ...
    def dict_para_geodataframe(dict_dados: dict, coluna_geometria: str = ParametrosConstantes.GEOMETRIA_COLUNA_DEFAULT, crs: str = ParametrosConstantes.GEOMETRIA_CRS_DEFAULT) -> GeoDataFrame:
        try:
            ...
            log.error(msg=f"Houve um erro ao gerar o GeoDataFrame a partir do dict. {ExceptionUtil.montar_exception_padrao(e)}")
            raise e
