...
class YAMLUtil:
    ...
    def converter_yaml_para_dict(arquivo_yaml: str) -> dict:
        try:
            ...
            log.error(msg=f"Houve um erro ao tentar recuperar os valores do arquivo YAML especificado no caminho {arquivo_yaml}. {ExceptionUtil.montar_erro_exception_padrao(e)}")
            raise e